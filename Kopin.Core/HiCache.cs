...
namespace Kopin.Core
{
    public sealed class HiCache
    {
        ...
        public static void InsertEx(string key, object obj, int seconds)
        {
            if (obj != null)
            {
                _cache.Insert(key, obj, null, DateTime.Now.AddSeconds((double)seconds), TimeSpan.Zero, CacheItemPriority.AboveNormal, null);
            }
        }
